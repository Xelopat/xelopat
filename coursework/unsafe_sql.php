...
<head>
    <meta charset="UTF-8">
    <title>Онлайн-библиотека: Поиск книг по автору (уязвимая страница)</title>
    <style>
...
?>
    <div>
        <p>Внимание: Эта страница уязвима к SQL-инъекциям.
           При любом непустом значении параметра поиск может быть нарушен.
           Например, попробуйте ввести следующий запрос в поле поиска:</p>
        <p>' UNION SELECT id, username, password, 1 FROM secret_data -- </p>
        <p>Этот запрос объединит результаты поиска с данными из таблицы secret_data и позволит извлечь секретную информацию.</p>
    </div>
</body>
</html>
